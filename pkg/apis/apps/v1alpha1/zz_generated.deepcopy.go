...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NexusCredentials) DeepCopyInto(out *NexusCredentials) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NexusCredentials.
func (in *NexusCredentials) DeepCopy() *NexusCredentials {
	if in == nil {
		return nil
	}
	out := new(NexusCredentials)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NexusResources) DeepCopyInto(out *NexusResources) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NexusResources.
func (in *NexusResources) DeepCopy() *NexusResources {
	if in == nil {
		return nil
	}
	out := new(NexusResources)
	in.DeepCopyInto(out)
	return out
}
