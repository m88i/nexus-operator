...
4. Make sure to always keep your version of `Go` and the `operator-sdk` on par with the project. The current version information may be found at [our README pre-requisites section](https://github.com/m88i/nexus-operator#pre-requisites)
