...
operator-sdk bundle create quay.io/m88i/nexus-operator.v${OP_VERSION}:latest -d ./deploy/olm-catalog/nexus-operator-m88i/${OP_VERSION} --package nexus-operator-m88i --channels alpha --overwrite --image-builder podman
